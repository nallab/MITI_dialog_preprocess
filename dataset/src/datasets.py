...
def divide_dialog(all_df, train_rate=0.8):
...
if __name__ == '__main__':
    all_df = load_MITI_dialog("../example-20200312/", "csv", num_pre_context=1)
    print(all_df['../example-20200312/case1.csv'].at[0, 'dialogue'])
    print(all_df['../example-20200312/case1.csv'].at[0, 'MITI_code'])
